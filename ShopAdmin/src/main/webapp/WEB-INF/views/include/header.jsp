...
<html lang="en">
  ...
  <!-- TOP NAV -->
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="/">Dream Admin</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="/member/insert">회원등록</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseNotices" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/notice/list">공지사항 리스트</a>
                                    <a class="nav-link" href="/notice/insert">공지사항 등록</a>
                                </nav>
                            </div>
