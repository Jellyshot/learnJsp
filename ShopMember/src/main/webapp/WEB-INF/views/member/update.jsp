	...
	<section class="post">
		...
		<form method="post" action="/member/update" name="join_form">
					<div class="row gtr-uniform">
						...
						<div class="col-12">
							<ul class= "actions">
								<li><a href="/member/upasswd?m_id=${member.m_id}" class="button">비밀번호 변경</a></li>
							</ul>
						</div>
						<!-- Break -->
						<div class="col-12">
						...
						<!-- 주소 -->		
						<div class="col-12">
						<input type="text" id="sample6_postcode" name="m_zipcode" value="${member.m_zipcode}">
						<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
						<input type="text" id="sample6_address" name="m_address01" value="${member.m_address01}"><br>
						<input type="text" id="sample6_detailAddress" name="m_address02" value="${member.m_address02}">
